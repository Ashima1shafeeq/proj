...
function Invoices() {
  ...
  const genInvoices = async () => {
    if (!deadline || !invoiceTitle || !invoiceAmount) {
      toast.error("Please set the deadline, title, and amount before generating invoices.", {
        position: "top-right",
        autoClose: 3000,
        theme: "dark",
      });
    ...
    try {
      const res = await fetch("http://localhost:3000/api/invoice/generate", {
        ...
        body: JSON.stringify({ hostel: hostel._id, deadline, title: invoiceTitle, amount: invoiceAmount })
      });
      setProgress(60);
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-3 items-center justify-center">
      ...
      <div className="mb-4">
        <label className="text-white">Invoice Title: </label>
        <input
          type="text"
          value={invoiceTitle}
      ...
      <div className="mb-4">
        <label className="text-white">Invoice Amount (in Rs): </label>
        <input
          type="number"
          value={invoiceAmount}
      ...
      <div className="mb-4">
        <label className="text-white">Set Invoice Deadline: </label>
        <input
          type="date"
          value={deadline}
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm truncate text-gray-400">
                        Room: {invoice.student.room_no} | Amount: Rs. {invoice.amount} | Title: {invoice.title}
                      </p>
                    </div>
